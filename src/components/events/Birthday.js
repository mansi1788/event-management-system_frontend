  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6 ">
        ...
        <img src="" alt="Wedding 3" className="rounded-lg w-96 h-80" />
        <img src="https://images.pexels.com/photos/19481253/pexels-photo-19481253/free-photo-of-cake-with-flares.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Wedding 3" className="rounded-lg w-96 h-80" />
