  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500">
      ...
      <div className="mb-6 mt-20">
        <img
          src='https://myshaadiwale.in/wp-content/uploads/2019/03/Traditional-wedding-planners-1400x430.jpg'
          alt="Destination Wedding"
          className="rounded-lg w-full h-96 object-cover mt-16" // Added margin-top for the image
        />
        <h1 className="text-4xl font-bold mt-4">Traditional Wedding</h1>
...
export default TraditionalDestination;
