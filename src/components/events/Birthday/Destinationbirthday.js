  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500">
      ...
      <div className="mb-6 mt-20">
        <img
          src='https://touristcity.pk/wp-content/uploads/2024/01/Destination-Birthday-Event-1536x560.jpg'
          alt="Destination Wedding"
          className="rounded-lg w-full h-96 object-cover mt-16" // Added margin-top for the image
        />
        <h1 className="text-4xl font-bold mt-4">Destination Birthday</h1>
        <p className="text-xl mt-2 mb-4">
        Destination Birthday is a celebration at a travel location, combining adventure and relaxation for a memorable getaway.
...
export default Destinationbirthday;
